...
class SocieteCession extends RequeteBase implements _idCession
{
    ...
    public function _idCession($ID_CESSION, array $array = null)
    {
        ...
        $societeACsExiste = new SocieteACsExiste();
        return $societeACsExiste->_avisDeCreditExiste($aCsCession, $array);
    }
}
